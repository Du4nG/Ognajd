...
def loginPage(request):
    ...
    if request.method == 'POST':
        ...
        if user is not None:
            ...
            messages.info(request,'Đcm bịp à?')
    context = {}
...
def home(request):
    ...
    context = {'products':products, 'cartItems':cartItems, 'categories':categories, 'user_not_login':user_not_login, 'user_login':user_login}
